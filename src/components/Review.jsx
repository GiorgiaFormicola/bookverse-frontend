  ...
  return (
    <>
      <ListGroup.Item className={`bv-review ${isUserReview ? "bv-review--own" : ""}`}>
        <div className="d-flex align-items-center gap-2 mb-2">
          ...
          <div className="flex-grow-1">
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <small className="fw-bold" style={{ color: "var(--text-muted)" }}>
                {review.rating}/5
              </small>
            </div>
          </div>
        ...
        {isUserReview && (
          <Button className="position-absolute bottom-0 end-0 me-2 mb-2 px-3 rounded-3" size="sm" onClick={handleReviewClick}>
            Edit
          </Button>
        )}
      </ListGroup.Item>

...
import { BookFill, BookHalf, People, Star, ThreeDots, StarFill } from "react-bootstrap-icons";
...
const BookDetailPage = () => {
  ...
  /* const mapBookDetails = () => {
    return {
      ...
      isbn10: book.isbn10 ? book.isbn10 : "Not available",
      isbn13: book.isbn13 ? book.isbn13 : "Not available",
      pages: book.pages ? book.pages : "Not available",
      categories: book.categories.length > 0 ? book.categories.join(", ") : "Not available",
          ...
          <Col xs={12} sm={11} md={10} lg={9}>
            <Row>
              <Col xs={12} className="order-lg-0">
                <div>
                  <h1 className="display-font mb-2" /* ADD DISPLAY-FONT */>{mappedBook.title}</h1>
                          ...
                          >
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              <div className="d-flex gap-2">
                                ...
                                {currentUserReview && (
                                  <Button type="button" className="px-4 fw-semibold bg-danger border-danger" onClick={() => deleteReview(currentUserReview.id)}>
                                    Delete
                                  </Button>
                                )}
                              </div>

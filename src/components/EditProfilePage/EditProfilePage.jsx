...
const EditProfilePage = () => {
  ...
  return (
    <>
      <Container fluid className="d-flex flex-column min-vh-100 p-5 gap-3">
        ...
        <Row>
          <Col xs={12}>
            ...
            >
              ...
              <Button disabled={!hasChanged() || loading} className=" fw-semibold bg-primary border-0 w-100 py-2 fs-4" type="submit">
                {loading ? "Updating profile..." : "Save"}
              </Button>
            </Form>
            <div className={"alert alert-danger text-center bg-transparent border-0 p-0 mt-3" + (error ? "" : " invisible")} role="alert">
